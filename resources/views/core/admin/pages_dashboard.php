  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">iBanking Admin Dashboard</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="row">
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">iBank Staffs</span>
                <span class="info-box-number">
                  <?php echo $iBStaffs;?>
                </span>
              </div>
        ...
        data: [{
          ...
          dataPoints: [
            { y:
              ...
              echo $savings;
              ?>
              , name: "Savings Acc", exploded: true },
            ...
            { y:
              ...
              $stmt->close();
              echo $Retirement;
              ?>, name: " Retirement Acc", exploded: true },
            ...
            { y: 
              ...
              $stmt->close();
              echo $Recurring;
              ?>, name: "Recurring deposit Acc ", exploded: true },
            ...
            { y:
              ...
              $stmt->close();
              echo $Fixed;
              ?>, name: "Fixed Deposit Acc", exploded: true },
            ...
            { y:
              ...
              $stmt->close();
              echo $Current;
              ?>, name: "Current Acc", exploded: true }
          ]
        }]
      });
        ...
        data: [{
          ...
          dataPoints: [
            { y:
              ...
              echo $Withdrawals;
              ?>
             , name: "Withdrawals", exploded: true },
